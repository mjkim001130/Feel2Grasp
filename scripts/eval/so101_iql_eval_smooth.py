...
# Circle detection
NUM_BG_FRAMES = 8
K_STD = 1.5  # Increased from 1.5 to reduce false positives
...
def main():
    ...
    try:
        ...
        while step < max_steps:
            ...
            # Clip gripper action to training data range (0-42)
            # Training data shows gripper values: 0 (closed) to ~42 (open)
